...
public:
  ...
  double getTotalWidth(Pythia8::ParticleDataEntryPtr p, double emcm,
	    int kf1=0, int kf2=0);
  double getPartialWidth(Pythia8::ParticleDataEntryPtr pd,double emcm, int kf1, int kf2);
  ...
  double deltaWidth(Pythia8::ParticleDataEntryPtr pd, int id0, double emcm,
	    int kf1=0, int kf2=0);
