...
double DecayWidth::getPartialWidth(Pythia8::ParticleDataEntryPtr pd,double emcm, int kf1, int kf2)
{
...
double DecayWidth::getTotalWidth(Pythia8::ParticleDataEntryPtr pd,double emcm, int kf1, int kf2)
{
//...Purpose: to calculate momentum dependent partial decay width
//...for resonances.
//======================================================================*
...
{
  Pythia8::ParticleDataEntryPtr pd=particleData->findParticle(kfd1);
  double widr=pd->mWidth();
  double mr=pd->m0();
  double mmin= pd->mMin();
  ...
  double mmax=m - m2;
  double s0=mmin + m2;
  //ParticleDataEntryPtr pd2=jamParticleData->find(kfd2);
  //double lam=pow4(0.8);
...
double DecayWidth::deltaWidth(Pythia8::ParticleDataEntryPtr pd, int id0, double emcm, int kf1, int kf2)
{
