...
{
private:
    typedef std::map<int,ParticleDataEntryPtr>  MapII;
    typedef std::map<std::string,ParticleDataEntryPtr>  MapSI;

    std::vector<ParticleDataEntryPtr> allParticleTable;
    MapII kfTable;
...
//...Light Mesons.
    ...
    */
    ...
    ParticleDataEntryPtr find(int kf);
    ParticleDataEntryPtr find(std::string name);
    ParticleDataEntryPtr findP(std::string name);
    ParticleDataEntryPtr findAntiP(std::string name);
    bool add(ParticleDataEntryPtr p);
    void merge(ParticleTable* t);

    ParticleDataEntryPtr getParticle(const int i) {
