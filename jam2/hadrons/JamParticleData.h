...
private:
    ...
    Pythia8::ParticleDataEntryPtr proton, neutron;
    Pythia8::ParticleDataEntryPtr deltam,delta0,deltap,deltapp;
    Pythia8::ParticleDataEntryPtr n1440, p1440;
    std::unordered_map<int,int> nstarID;
    std::unordered_map<int,int> dstarID;
    std::unordered_map<ParticleDataEntryPtr,DecayWidthTable*> decayWidthTable;
...
public:
    ...
    Pythia8::ParticleDataEntryPtr find(int kf) {return table->findParticle(kf);}
    Pythia8::ParticleDataEntryPtr getProton() {return proton;}
    Pythia8::ParticleDataEntryPtr getNeutron() {return neutron;}
    Pythia8::ParticleDataEntryPtr getDeltam() {return deltam;}
    Pythia8::ParticleDataEntryPtr getDelta0() {return delta0;}
    Pythia8::ParticleDataEntryPtr getDeltap() {return deltap;}
    Pythia8::ParticleDataEntryPtr getDeltapp() {return deltapp;}
    Pythia8::ParticleDataEntryPtr getN1440() {return n1440;}
    Pythia8::ParticleDataEntryPtr getP1440() {return p1440;}
  ...
  double totalWidth(Pythia8::ParticleDataEntryPtr pd, double m) {
  ...
  double lifeTime(Pythia8::ParticleDataEntryPtr pd,double m, double e);
