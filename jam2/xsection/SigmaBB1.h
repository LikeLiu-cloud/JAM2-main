...
public:
    ...
    double DetBal1(int msel,Pythia8::ParticleDataEntryPtr p,double m1,double m2);
    double DetBal2(int msel);
    double DetBal3();
    double BW1(int idetsw,Pythia8::ParticleDataEntryPtr p,double em,double mr0,double m2);
    double BW2(double m1,double emin2);
    double BW3(double m1,double m2);
    Pythia8::ParticleDataEntryPtr selectDN(int idn, int& idr);
    Pythia8::ParticleDataEntryPtr selectResonance(ParticleTable* t);
