...
private:
  ...
  Pythia8::Vec4 force;
  Pythia8::ParticleDataEntryPtr pdePtr;
  CascBox *cBox;
...
public:
  EventParticle(const int id0=0, ParticleDataEntryPtr pd=0);
  EventParticle(int id0, double m,Vec4 r0, Vec4 p0,ParticleDataEntryPtr pd=0, int ip=0);
  ...
  Pythia8::ParticleDataEntryPtr getParticleDataEntry() {return pdePtr;}
  void setParticleData(Pythia8::ParticleDataEntryPtr pd) {pdePtr=pd;}
  ...
  void setRhoS(double r0) {rhoS=r0;}
  void setRhoB(double r0) {rhoB=r0;}
  ...
  void setPotV(Vec4 v0) {potV=v0;}
  void setPotVm(Vec4 v0) {potVm=v0;}
  void setPotV(int i,double v0) {potV[i]=v0;}
  void setPotVm(int i,double v0) {potVm[i]=v0;}
